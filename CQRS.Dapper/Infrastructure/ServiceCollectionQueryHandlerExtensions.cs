...
namespace CQRS.Dapper.Infrastructure
{
    ...
    {
        public static void AddQueryHandler<TQueryHandler, TQuery, TResult>(this IServiceCollection @this) where TQueryHandler : class, IQueryHandler<TQuery, TResult> where TQuery : class
        {
